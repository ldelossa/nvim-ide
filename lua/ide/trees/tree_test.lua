...
function M.test_functionality()
    ...
    root.marshal = function() return "+", "test_root", "root node" end
    local c1 = node.new("test", "test_c1", "test_c1")
    c1.marshal = function() return "-", "test_c1", "test child 1" end
    local c2 = node.new("test", "test_c2", "test_c2")
    c2.marshal = function() return "-", "test_c2", "test child 2" end
    ...
    c1_1.marshal = function() return "-", "test_c1.1", "test child 1.1" end
    t.add_node(c1, { c1_1 })
    t.marshal()
    check_tc(2, buf)
    ...
    c1_1_1.marshal = function() return "-", "test_c1.1.1", "test child 1.1.1" end
